...
public class OverlayNodeSendsDeregistration {
	  ...
	  public OverlayNodeSendsDeregistration(int type,String ip, int port, int nodeId)
	  {
		  this.type=type;
		  this.ip_address=ip;
		  this.port=port;		  
	  ...
	  public OverlayNodeSendsDeregistration(byte[] marshalledBytes) throws IOException    //constructor in case this message is received - ie load structure from bytes
	  {
